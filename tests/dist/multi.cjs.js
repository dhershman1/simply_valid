...
const creditCard = val => executeValidation(val, 'creditCard');

const date = val => executeValidation(val, 'date');

const cvn = val => executeValidation(val, 'cvn');

const zipPost = val => executeValidation(val, 'zipPost');
